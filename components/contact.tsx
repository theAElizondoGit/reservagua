...
export default function Contact() {
  ...
  return (
    <section id="contacto" className="bg-white text-black py-12 px-6 lg:py-16 lg:px-24">
      <div className="container mx-auto">
        ...
        <p className="text-lg lg:text-xl font-medium mb-10 text-center lg:text-left">
          Nos encantaría saber de ti. Ya sea que tengas dudas sobre nuestros productos, 
          quieras agendar una instalación o necesites asistencia personalizada, 
          nuestro equipo está listo para ayudarte. Llena el siguiente formulario y nos pondremos 
